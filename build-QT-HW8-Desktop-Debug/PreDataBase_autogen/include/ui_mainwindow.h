...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tb_result = new QTableWidget(centralwidget);
        tb_result->setObjectName("tb_result");
        QSizePolicy sizePolicy(QSizePolicy::Minimum, QSizePolicy::Expanding);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(tb_result->sizePolicy().hasHeightForWidth());
        tb_result->setSizePolicy(sizePolicy);

        gridLayout->addWidget(tb_result, 1, 0, 4, 1);
        ...
        sizePolicy1.setHeightForWidth(lb_statusConnect->sizePolicy().hasHeightForWidth());
        lb_statusConnect->setSizePolicy(sizePolicy1);
        ...
        sizePolicy3.setHeightForWidth(gb_filters->sizePolicy().hasHeightForWidth());
        gb_filters->setSizePolicy(sizePolicy3);
